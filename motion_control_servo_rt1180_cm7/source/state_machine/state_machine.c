...
/*! @brief State machine function field - fast */
 pfcn_void_psm g_SM_STATE_TABLE_FAST[4] = {SM_StateFaultFast, SM_StateInitFast, SM_StateStopFast, SM_StateRunFast};

/*! @brief State machine function field - slow */
 pfcn_void_psm g_SM_STATE_TABLE_SLOW[4] = {SM_StateFaultSlow, SM_StateInitSlow, SM_StateStopSlow, SM_StateRunSlow};
 ...
 * @return None
 */
RAM_FUNC_CRITICAL static void SM_StateFaultFast(sm_app_ctrl_t *psAppCtrl)
{
    /* User Fault function */
 ...
 * @return None
 */
RAM_FUNC_CRITICAL static void SM_StateInitFast(sm_app_ctrl_t *psAppCtrl)
{
    /* User Init function */
 ...
 * @return None
 */
RAM_FUNC_CRITICAL static void SM_StateStopFast(sm_app_ctrl_t *psAppCtrl)
{
    /* User Stop function */
 ...
 * @return None
 */
RAM_FUNC_CRITICAL static void SM_StateRunFast(sm_app_ctrl_t *psAppCtrl)
{
    /* User Run function */
 ...
 * @return None
 */
RAM_FUNC_CRITICAL static void SM_StateFaultSlow(sm_app_ctrl_t *psAppCtrl)
{
 ...
 * @return None
 */
RAM_FUNC_CRITICAL static void SM_StateInitSlow(sm_app_ctrl_t *psAppCtrl)
{
 ...
 * @return None
 */
RAM_FUNC_CRITICAL static void SM_StateStopSlow(sm_app_ctrl_t *psAppCtrl)
{
 ...
 * @return None
 */
RAM_FUNC_CRITICAL static void SM_StateRunSlow(sm_app_ctrl_t *psAppCtrl)
{
