...
//    f16ModuloTemp = this->pui32PwmBaseAddress->SM[this->ui16PhASubNum].VAL1 + 1;
    ...
    this->pui32PwmBaseAddress->SM[this->ui16PhCSubNum].VAL2 = f16DutyCycle;
    this->pui32PwmBaseAddress->SM[this->ui16PhCSubNum].VAL3 = f16DutyCycleTemp;
#else
    ...
    if(this->ui16PWMUpdateSel == 1)
    {
    	this->ui16PWMUpdateSel = 0;
    ...
    else if(this->ui16PWMUpdateSel == 0)
    {
    	this->ui16PWMUpdateSel = 1;
...
bool_t MCDRV_eFlexPwm3PhFaultGet(mcdrv_pwm3ph_pwma_t *this)
{
    ...
    ui16StatusFlags = (((this->pui32PwmBaseAddress->FSTS & PWM_FSTS_FFLAG_MASK) >> PWM_FSTS_FFLAG_SHIFT) &
                    ((uint16_t)(1) << this->ui16FaultFixNum | (uint16_t)(1) << this->ui16FaultAdjNum | (uint16_t)(1) << this->ui16FaultAdjNum1));
