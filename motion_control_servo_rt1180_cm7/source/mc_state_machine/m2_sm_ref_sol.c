...
RAM_FUNC_CRITICAL static void M2_StateFaultFast(void)
{
    ...
    g_sM2Drive.f16PosElEnc = g_sM2TamagawaAbs.f16PosElec;
#endif
#if SINC_CLOSEDLOOP == ENABLED
    g_sM2Drive.sFocPMSM.fltUDcBus = g_sM1SincFilter.fltUdc;
#else
...
RAM_FUNC_CRITICAL static void M2_StateInitFast(void)
{
    ...
    g_sM2Drive.sSpeed.sSpdPiParamsTest.fltPGain = M2_SPEED_PI_PROP_GAIN;
    g_sM2Drive.sSpeed.sSpdPiParamsTest.fltIGain = M2_SPEED_PI_INTEG_GAIN;
    g_sM2Drive.sSpeed.sSpdPiParamsTest.fltMax = M2_SPEED_LOOP_HIGH_LIMIT;
    g_sM2Drive.sSpeed.sSpdPiParamsTest.fltMin = M2_SPEED_LOOP_LOW_LIMIT;
    ...
    g_sM2Drive.sSpeed.sSpeedDeepFilter.sFltCoeff.fltB0 = M2_SPEED_DEEP_IIR_B0;
    g_sM2Drive.sSpeed.sSpeedDeepFilter.sFltCoeff.fltB1 = M2_SPEED_DEEP_IIR_B1;
    g_sM2Drive.sSpeed.sSpeedDeepFilter.sFltCoeff.fltA1 = M2_SPEED_DEEP_IIR_A1;
    GDFLIB_FilterIIR1Init_FLT(&g_sM2Drive.sSpeed.sSpeedDeepFilter);

    g_sM2Drive.sFocPMSM.sCurReqFWFilter.sFltCoeff.fltB0 = M2_CURREQFW_IIR_B0;
    g_sM2Drive.sFocPMSM.sCurReqFWFilter.sFltCoeff.fltB1 = M2_CURREQFW_IIR_B1;
    g_sM2Drive.sFocPMSM.sCurReqFWFilter.sFltCoeff.fltA1 = M2_CURREQFW_IIR_A1;
    GDFLIB_FilterIIR1Init_FLT(&g_sM2Drive.sFocPMSM.sCurReqFWFilter);

    g_sM2Drive.sPosition.sSpdFwdFilter.sFltCoeff.fltB0 = M2_SPD_FWD_IIR_B0;
    g_sM2Drive.sPosition.sSpdFwdFilter.sFltCoeff.fltB1 = M2_SPD_FWD_IIR_B1;
    g_sM2Drive.sPosition.sSpdFwdFilter.sFltCoeff.fltA1 = M2_SPD_FWD_IIR_A1;
    GDFLIB_FilterIIR1Init_FLT(&g_sM2Drive.sPosition.sSpdFwdFilter);
...
#else
    /* For ADC driver */
    g_sM2AdcSensor.pf16UDcBus     = &(sM2_ADCRslt.f16UDcBus);
    g_sM2AdcSensor.psIABC         = &(sM2_ADCRslt.sIABCFrac);
    g_sM2AdcSensor.pui16SVMSector = &(g_sM2Drive.sFocPMSM.ui16SectorSVM);
    g_sM2AdcSensor.pui16AuxChan   = &(sM2_ADCRslt.f16AdcAuxSample);
#endif
...
#elif POSITION_SENSOR == TAMAGAWA_ABS_ENC
    MCDRV_TamagawaAbsInit(&g_sM2TamagawaAbs);
...
//	MCDRV_VoltDcBusGet(&g_sM2AdcSensor);
//	MCDRV_AuxValGet(&g_sM2AdcSensor);//Todo M1 do not have
//	MCDRV_Curr3Ph2ShGet(&g_sM2AdcSensor);//M1 do not have
#if POSITION_SENSOR == OPTICAL_ENC 
    /* get rotor position and speed from quadrature encoder sensor */
	if(g_sM2QdcSensor.bPosAbsoluteFlag == TRUE)
	{
 ...
 * @return None
 */
volatile uint32_t ui32PWMRegTime;
volatile uint32_t ui32ADCRegTime;
RAM_FUNC_CRITICAL static void M2_StateRunFast(void)
{
	...
	if(g_sM2QdcSensor.bPosAbsoluteFlag == TRUE)
	{
		MCDRV_GetRotorCurrentPos(&g_sM2QdcSensor); // read register 3 times
		MCDRV_GetRotorCurrentRev(&g_sM2QdcSensor); // read register 4 times
		g_sM2Drive.f16PosElEnc = g_sM2QdcSensor.f16PosElec;
    }
#elif POSITION_SENSOR == TAMAGAWA_ABS_ENC
    g_sM2Drive.f16PosElEnc = g_sM2TamagawaAbs.f16PosElec;
...
//#if SINC_CLOSEDLOOP == ENABLED
//    g_sM2Drive.sFocPMSM.fltUDcBus = g_sM1SincFilter.fltUdc;
//    g_sM2Drive.sFocPMSM.sIABC.fltA = g_sM2SincFilter.fltIa;
//    g_sM2Drive.sFocPMSM.sIABC.fltB = g_sM2SincFilter.fltIb;
//    g_sM2Drive.sFocPMSM.sIABC.fltC = g_sM2SincFilter.fltIc;
//#else
...
//
//    /* PWM peripheral update */
//    MCDRV_eFlexPwm3PhDutyUpdate(&g_sM2Pwm3ph); // Write register 2 times, read register 7 times
    ...
    {
      	f32AnglePosM2 += MLIB_Mul_F32(FRAC32(2.0*FREQ_POS_SCALE_M2/M2_FAST_LOOP_FREQ), f32FreqInPosM2);
...
RAM_FUNC_CRITICAL static void M2_StateRunReadyFast(void)
{
    ...
    case kControlMode_VoltageFOC:
        if (!(g_sM2Drive.sMCATctrl.sUDQReqMCAT.fltQ == 0.0F ))
        {
            ...
            /* Transition to the RUN ALIGN sub-state */
            /*Todo*/
            if(((g_sM2QdcSensor.bPosAbsoluteFlag == TRUE)||(g_sM2TamagawaAbs.bPosAbsoluteFlag == TRUE))&&(g_sM2Drive.sMCATctrl.ui16PospeSensor == MCAT_ENC_CTRL))
            {
    ...
    default: 
    	...
    	{
            if((g_sM2QdcSensor.bPosAbsoluteFlag == TRUE)||(g_sM2TamagawaAbs.bPosAbsoluteFlag == TRUE) ||(g_sM2TamagawaAbs.bPosAbsoluteFlag == TRUE))
            {
            	M2_TransRunReadySpin();
            }
            else
...
#elif POSITION_SENSOR == TAMAGAWA_ABS_ENC
            g_sM2Drive.sSpeed.fltSpeed = g_sM2TamagawaAbs.sSpeed.fltSpeed;
#endif  
        else
...
#elif POSITION_SENSOR == TAMAGAWA_ABS_ENC
            g_sM2Drive.sSpeed.fltSpeed = g_sM2TamagawaAbs.sSpeed.fltSpeed;
//            g_sM2Drive.sSpeed.fltSpeed = g_sM2TamagawaAbs.sSpeedEstim.fltSpeedEstim;
#endif
//        else
            /* pass estimated speed to actual speed value */
//            g_sM2Drive.sSpeed.fltSpeed = g_sM2Drive.sFocPMSM.fltSpeedElEst;
...
RAM_FUNC_CRITICAL static void M2_StateRunSpinSlow(void)
{
    if(g_sM2Drive.eControl == kControlMode_SpeedFOC)
    {
        ...
        g_sM2Drive.sPosition.i32Q16PosFdbk = g_sM2TamagawaAbs.i32Q16DeltaRev;
#endif        
    	if(g_sM2Drive.sMCATctrl.ui16PospeSensor == MCAT_ENC_CTRL)
    	{
        /* actual speed filter */
...
#if USEIIRFORBW
    		g_sM2Drive.sSpeed.fltSpeedFilt = GDFLIB_FilterIIR1_FLT(g_sM2Drive.sSpeed.fltSpeed, &g_sM2Drive.sSpeed.sSpeedFilter);
//    		g_sM2Drive.sSpeed.fltSpeedDeepFilt = GDFLIB_FilterIIR1_FLT(g_sM2Drive.sSpeed.fltSpeed, &g_sM2Drive.sSpeed.sSpeedDeepFilter);
#else
            g_sM2Drive.sSpeed.fltSpeedFilt = g_sM2Drive.sSpeed.fltSpeed;
#endif
#endif
...
#else
        g_sM2Drive.sFocPMSM.sIDQReq.fltQ = GDFLIB_FilterIIR1_FLT(g_sM2Drive.sSpeed.fltIqReq, &g_sM2Drive.sFocPMSM.sCurReqFWFilter);
#endif
...
//    		g_sM2Drive.sSpeed.fltSpeedDeepFilt = GDFLIB_FilterIIR1_FLT(g_sM2Drive.sSpeed.fltSpeed, &g_sM2Drive.sSpeed.sSpeedDeepFilter);
        ...
        {
        	g_sM2Drive.sPosition.i32Q16PosOffSet -= ACC32(0.00125);
        	if(g_sM2Drive.sPosition.i32Q16PosErr > ACC32(0.1))
        	{
        		bPosInitAlginFlag = 1;
            	g_sM2Drive.sPosition.i32Q16PosOffSet = g_sM2Drive.sPosition.i32Q16PosOffSet +g_sM2Drive.sPosition.i32Q16PosErr + ACC32(19.4);
        	}
        }
#else
        g_sM2Drive.sPosition.i32Q16PosOffSet = g_sM2TamagawaAbs.f32PosMechOffsetforAlign>>1;
#endif
...
#elif POSITION_SENSOR == TAMAGAWA_ABS_ENC
	MCDRV_AbsGetRotorInitPos(&g_sM2TamagawaAbs, MLIB_Conv_F32s(g_sM2Drive.sAlignment.f16PosAlign));
	MCDRV_AbsGetRotorInitRev(&g_sM2TamagawaAbs);
#endif  
...
RAM_FUNC_CRITICAL static void M2_TransRunReadySpin(void)
{
    ...
    MCDRV_AbsGetRotorInitRev(&g_sM2TamagawaAbs);
    bPosInitAlginFlag = 0;
	g_sM2Drive.sPosition.i32Q16PosOffSet = 0;
#endif
...
RAM_FUNC_CRITICAL static void M2_ClearFOCVariables(void)
{
    ...
    g_sM2Drive.sSpeed.sSpeedDeepFilter.fltFltBfrX[0] = 0.0F;
    g_sM2Drive.sSpeed.sSpeedDeepFilter.fltFltBfrY[0] = 0.0F;
    GDFLIB_FilterIIR1Init_FLT(&g_sM2Drive.sSpeed.sSpeedDeepFilter);

    g_sM2Drive.sPosition.sSpdFwdFilter.fltFltBfrX[0] = 0.0F;
    g_sM2Drive.sPosition.sSpdFwdFilter.fltFltBfrY[0] = 0.0F;
    GDFLIB_FilterIIR1Init_FLT(&g_sM2Drive.sPosition.sSpdFwdFilter);

    g_sM2Drive.sFocPMSM.sCurReqFWFilter.fltFltBfrX[0] = 0.0F;
    g_sM2Drive.sFocPMSM.sCurReqFWFilter.fltFltBfrY[0] = 0.0F;
    GDFLIB_FilterIIR1Init_FLT(&g_sM2Drive.sFocPMSM.sCurReqFWFilter);
    PIControllerDesatInit(&g_sM2Drive.sSpeed.sSpeedPiParamsDesat);
    PIController_Init(&g_sM2Drive.sSpeed.sSpdPiParamsTest);
...
RAM_FUNC_CRITICAL static void M2_FaultDetection(void)
{
    ...
    /* Tamagawa abs error */
    if(g_sM2TamagawaAbs.ui16Status)
    {
        FAULT_SET(g_sM2Drive.sFaultIdPending, FAULT_TAMAGAWA_ABS);
    }
#endif
    /* GD3000:   reset */
...
RAM_FUNC_CRITICAL void M2_FastLoopCriticalCode(void)
{
#if POSITION_SENSOR == OPTICAL_ENC
    /* get rotor position and speed from quadrature encoder sensor */
	if(g_sM2QdcSensor.bPosAbsoluteFlag == TRUE)
    ...
    if(g_sM2Ctrl.eState == kSM_AppRun)
    {
        /* Run sub-state function */
        s_M2_STATE_RUN_TABLE_FAST[g_eM2StateRun]();
