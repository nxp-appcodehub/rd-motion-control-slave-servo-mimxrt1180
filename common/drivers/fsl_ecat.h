...
#define ECAT_EscRead(ecat, pData, Address, Len)  Ecat_Read(ecat, pData, Address, Len)
...
#define ECAT_EscWrite(ecat, pData, Address, Len) Ecat_Write(ecat, pData, Address, Len)
//		MC_ReadReadWriteFlag(); \
