...
- {id: LPUART0506_CLK_ROOT.outFreq, value: 80 MHz}
- {id: LPUART0708_CLK_ROOT.outFreq, value: 80 MHz}
...
- {id: ANADIG_PLL.ARM_PLL_VDIV.scale, value: '133'}
...
- {id: CCM.CLOCK_ROOT29.DIV.scale, value: '5', locked: true}
- {id: CCM.CLOCK_ROOT29.MUX.sel, value: ANADIG_OSC.OSC_RC_400M}
- {id: CCM.CLOCK_ROOT3.DIV.scale, value: '4', locked: true}
- {id: CCM.CLOCK_ROOT3.MUX.sel, value: ANADIG_PLL.SYS_PLL2_CLK}
- {id: CCM.CLOCK_ROOT30.DIV.scale, value: '5', locked: true}
- {id: CCM.CLOCK_ROOT30.MUX.sel, value: ANADIG_OSC.OSC_RC_400M}
...
- {id: CLK_ROOT21_INIT_Config, value: disabled}
...
void BOARD_BootClockRUN(void)
{
    ...
    /* Configure LPUART0506 using OSC_RC_400M */
    rootCfg.mux = kCLOCK_LPUART0506_ClockRoot_MuxOscRc400M;
    rootCfg.div = 5;
    CLOCK_SetRootClock(kCLOCK_Root_Lpuart0506, &rootCfg);

    /* Configure LPUART0708 using OSC_RC_400M */
    rootCfg.mux = kCLOCK_LPUART0708_ClockRoot_MuxOscRc400M;
    rootCfg.div = 5;
