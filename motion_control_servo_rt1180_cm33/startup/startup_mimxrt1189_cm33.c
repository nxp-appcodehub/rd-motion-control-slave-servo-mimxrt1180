...
extern void (* const g_pfnVectorsRAM[])(void);
extern void * __Vectors __attribute__ ((alias ("g_pfnVectorsRAM")));
...
__attribute__ ((used, section(".isr_vector_ram")))
void (* const g_pfnVectorsRAM[])(void) = {
    // Core Level - CM33
    &_vStackTop,                       // The initial stack pointer
    ResetISR,                          // The reset handler
    NMI_Handler,                       // NMI Handler
    ...
    XBAR1_CH0_CH1_IRQHandler,                        // 160: XBAR channel 0/1 interrupt
    XBAR1_CH2_CH3_IRQHandler,                        // 161: XBAR channel 2/3 interrupt
    ...
    LPTMR3_IRQHandler,                          // 166: LPTMR interrupt
    ...
    EDGELOCK_REQ1_IRQHandler,                        // 177:
    EDGELOCK_REQ2_IRQHandler,                        // 178:
    EDGELOCK_REQ3_IRQHandler,                        // 179:
...
// will setup the VTOR register
    ...
    SCB->VTOR = (uint32_t)g_pfnVectorsRAM;
#endif
    // Reenable interrupts
